...
chance_title: `Yoshingiz <span class="hl">15 dan 21 gacha!</span><br>Va siz jonli kuylay olasiz!<br>Demak, bu sizning sahnangiz!`,
    ...
    form_card_title: `Anketani to‘ldiring`,
    form_sub: `Anketani to‘ldiring — biz siz bilan bog'lanib, kasting vaqti hamda manzilini ma'lum qilamiz.`,
    ...
    err_age: `Yosh 15–21 oralig'ida bo'lishi kerak`,
  ...
  ru: {
    ...
    form_card_title: `Заполните анкету`,
    form_sub: `Заполните анкету — мы свяжемся с вами и сообщим время и место кастинга.`,
    ...
    err_age: `Возраст должен быть от 15 до 21 года`,
  ...
  en: {
    ...
    form_card_title: `Fill in the form`,
    form_sub: `Fill in the form — we will contact you and provide the casting time and location.`,
    ...
    err_age: `Age must be between 15 and 21`,
...
function initForm() {
  ...
  form.addEventListener(
    ...
    async (e) => {
      ...
      submitBtn
        .querySelector(".btn__label")
        .textContent =
        DICT[lang].submit_loading;
      ...
      try {
        ...
        alert(
          DICT[lang].err_phone &&
            "Xatolik. Qayta urinib ko'ring / Ошибка. Попробуйте ещё раз / Something went wrong, please try again."
        );
      }
    }
  );
...
function setFieldError(el, on) {
  // Consent checkbox has its own error node
  // outside .field.
  if (el.id === "f-consent") {
    const node =
