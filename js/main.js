...
chance_title: `Yoshingiz <span class="hl">15 dan 21 gacha!</span><br>Va siz jonli kuylay olasiz!<br>Demak, bu sizning sahnangiz!`,
    ...
    s1_address: `Ro‘yxatga olingan manzil`,
    s1_phone: `Telefon`,
    s1_email: `E-mail`,
    s1_socials: `Ijtimoiy tarmoqlar`,
    s1_agenote: `Ishtirokchilar anketa topshirish paytida 15 dan 21 yoshgacha bo‘lishi shart.`,
  ...
  ru: {
    ...
    s1_address: `Адрес регистрации`,
    s1_phone: `Телефон`,
    s1_email: `E-mail`,
    s1_socials: `Соцсети`,
    s1_agenote: `На момент подачи анкеты участнику должно быть от 15 до 21 года включительно.`,
  ...
  en: {
    ...
    s1_address: `Registered address`,
    s1_phone: `Phone`,
    s1_email: `E-mail`,
    s1_socials: `Social media`,
    s1_agenote: `Participants must be between 15 and 21 years old at the time of applying.`,
